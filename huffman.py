...
class HuffmanTree:
    ...
    def mlp(self, id=None, softmax_activation=False):
        ...
        with tf.variable_scope('node_' + str(id), reuse=tf.AUTO_REUSE):
            state = self.feature_extract_caser(self.input_state, self.input_state_length)
    ...
    def get_all_action_prob(self, input_state, input_state_length):
